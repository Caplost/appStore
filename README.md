...
# 1.快速创建代码仓库请使用下方命令
```
sudo docker run --rm -v $(pwd): $(pwd) -w  $(pwd) -e ICODE=xxxxxx cap1573/cap-tool newService git.imooc.com/cap1573/appStore
...
5.这里git.imooc.com/cap1573/appStore 仓库名字需要和 go mod 名称一致
```
